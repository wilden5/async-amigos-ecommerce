...
import solidUrl from '../../../src/assets/about-us/solid.png';
import wilden5Url from '../../../src/assets/about-us/wilden5.png';
import linseazUrl from '../../../src/assets/about-us/linseaz.png';
import schoolUrl from '../../../src/assets/rs_school.svg';

jest.mock('../../../src/assets/about-us/linseaz.png', () => ({
  default: 'mock-image',
}));

jest.mock('../../../src/assets/about-us/solid.png', () => ({
  default: 'mock-image',
}));

jest.mock('../../../src/assets/about-us/wilden5.png', () => ({
  default: 'mock-image',
}));

jest.mock('../../../src/assets/rs_school.svg', () => ({
  default: 'mock-image',
}));
